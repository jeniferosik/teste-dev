...
export function CharacterCard({ character }: { character: Character }) {
  ...
  useEffect(() => {
    function resetAnimations() {
      ...
      burstRef.current?.getAnimations().forEach((a) => a.cancel())
      contentRef.current?.getAnimations().forEach((a) => a.cancel())
  ...
  return (
    <div className="relative h-full w-full" style={{ willChange: "transform, opacity" }}>
      <span
        ref={burstRef}
        aria-hidden="true"
